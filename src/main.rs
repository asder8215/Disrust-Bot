        ...
        // }
            ...
            if let Some(image) = msg.attachments.get(0) {
                ...
                if let (Some(img_width), Some(img_height)) = (image.width, image.height) {
                        ...
                        let builder = CreateMessage::new()
                        .content(format!(
                            "Here's the image I'm compressing"
                        ))
                        .add_file(attachment.expect("Failed to receive user's image"));
                        ...
                        let _ = msg
                            .channel_id
                            .say(&ctx.http, format!("Compressing image..."))
                            .await;
            ...
            let _ = msg
                            .channel_id
                            .say(&ctx.http, format!("Done compressing image!"))
                            .await;
        }
    }
